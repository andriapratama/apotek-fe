...
function ProductCreate() {
	...
	return (
		<section className="product-create min-h-[80vh] w-full">
			<div className="product-create__head mb-5">
				<span className="text-2xl text-slate-600">Add Product</span>
			</div>

			<form
				className="product-create__body mb-5 w-full rounded-lg border border-slate-200 bg-white shadow-lg shadow-slate-400"
				onSubmit={formik.handleSubmit}
			>
				<div className="py-10 px-20">
					{errorMessage ? (
						<div className="mb-5 w-full rounded-lg bg-red-200 py-5 text-center text-lg font-semibold tracking-wider text-red-500">
							{errorMessage}
						</div>
					) : null}
