...
export const PaginationStock = ({
	...
	const pageRedux = store.getState().paginationStock.page;
...
export const PaginationPrice = ({
	...
	const pageRedux = store.getState().paginationPrice.page;
